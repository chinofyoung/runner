                  ...
                  {stravaConnected ? (
                    <>
                      ...
                      <button
                        ...
                        className="px-3 py-1.5 border border-gray-600 text-gray-300 rounded-lg hover:bg-gray-700 transition-colors text-sm"
                      >
                        Disconnect
                      </button>
                    </>
              ...
              <div className="bg-gray-800 rounded-xl shadow-sm p-5 border border-gray-700">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <button
                    ...
                    disabled={syncing}
                    className={`px-4 py-2 rounded-lg font-medium transition-colors text-sm ${syncing
                  ...
                  <div className="grid grid-cols-2 gap-4 text-sm">
                    ...
                    {syncStatus.lastSync && (
                      <div className="flex items-center justify-end">
                        <span
                          className={`px-2 py-1 rounded-full text-xs font-medium ${syncStatus.lastSync.status === "completed"
            ...
            <div className="bg-gray-800 rounded-xl shadow-sm p-6 border border-gray-700">
                  ...
                  <div>
                    ...
                    <div className="flex items-center h-10">
                      <label className="flex items-center cursor-pointer">
                        <input
                          type="checkbox"
                          className="w-4 h-4 text-green-500 border-gray-600 rounded focus:ring-green-500 focus:ring-2 bg-gray-700"
              ...
              <div className="mb-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                  <div>
                    <label className="block text-sm font-medium text-gray-400 mb-2">
                      Max HR <span className="text-gray-500">(bpm)</span>
                    </label>
                    <input
                      type="number"
                      placeholder="190"
                  ...
                  <div>
                    <label className="block text-sm font-medium text-gray-400 mb-2">
                      Resting HR <span className="text-gray-500">(bpm)</span>
                    </label>
                    <input
                      type="number"
                      placeholder="60"
                  ...
                  <div>
                    <label className="block text-sm font-medium text-gray-400 mb-2">
                      LTHR <span className="text-gray-500">(bpm)</span>
                    </label>
                    <input
                      type="number"
                      placeholder="170"
              ...
              <div className="space-y-4">
                ...
                <div className="p-3 bg-gray-700/50 rounded-lg border border-gray-600">
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <span
                      className={`px-2 py-1 rounded-full text-xs font-medium ${syncStatus?.hasData
                        ? "bg-green-100 text-green-800"
                        : stravaConnected
                          ? "bg-yellow-100 text-yellow-800"
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div className="p-3 bg-blue-900/30 rounded-lg text-center border border-blue-800/50">
                    ...
                    <div className="text-xs text-blue-400">Runs</div>
                  </div>
                  <div className="p-3 bg-green-900/30 rounded-lg text-center border border-green-800/50">
                    ...
                    <div className="text-xs text-green-400">KM</div>
                  </div>
                </div>
